        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNumber,60L, TimeUnit.SECONDS,this,
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                    ...
                    public void onCodeAutoRetrievalTimeOut(String s) {
                        ...
                        Toast.makeText(net.smallacademy.otpauth.Register.this, "OTP Timeout, Please Re-generate the OTP Again.", Toast.LENGTH_SHORT).show();
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        Toast.makeText(net.smallacademy.otpauth.Register.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        fAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(net.smallacademy.otpauth.Register.this, "Phone Verified."+fAuth.getCurrentUser().getUid(), Toast.LENGTH_SHORT).show();
                    checkUserProfile();
                }else {
                    progressBar.setVisibility(View.GONE);
                    state.setVisibility(View.GONE);
                    Toast.makeText(net.smallacademy.otpauth.Register.this, "Can not Verify phone and Create Account.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkUserProfile() {
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(net.smallacademy.otpauth.Register.this, "Profile Do Not Exists", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
